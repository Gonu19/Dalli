...
const styles=StyleSheet.create({title:{position:'absolute',left:27,right:27,top:108,color:colors.white,fontSize:20,fontWeight:'800',textAlign:'center'},subtitle:{position:'absolute',left:27,right:27,top:143,color:colors.white,fontSize:14,textAlign:'center'},options:{position:'absolute',left:38,top:188,right:30},button:{top:606}});
