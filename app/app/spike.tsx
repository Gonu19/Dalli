...
const styles = StyleSheet.create({
  ...
  cardTitle: { ...typography.heading, color: colors.ink, flex: 1 },
  ...
  metric: { ...typography.display, color: colors.ink },
  unit: { ...typography.bodyStrong, color: colors.inkMuted },
  detail: { ...typography.body, color: colors.inkMuted },
});
