...
const styles = StyleSheet.create({
  ...
  header: { position: 'absolute', top: navigationHeader.titleTop, left: 27, zIndex: 10, color: colors.white, fontSize: 17, fontWeight: '700' }, headerAccent: { color: colors.primary },
