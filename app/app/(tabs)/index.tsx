...
const styles = StyleSheet.create({
  ...
  // 내용 길이가 상황마다 달라진다(계획 없음·오프라인·오류). 높이를 묶으면 글자가 카드 밖으로 흘러나간다.
  goal: { position: 'absolute', left: 27, right: 28, top: 241 - navigationHeader.contentLift, minHeight: 164, borderRadius: 28, backgroundColor: colors.white, padding: 22 },
  goalLabel: { fontSize: 17, fontWeight: '700', color: colors.ink },
  goalValue: { fontSize: 30, fontWeight: '800', color: colors.ink, lineHeight: 38, marginTop: 14 },
  goalEmpty: { fontSize: 21, fontWeight: '800', color: colors.ink, lineHeight: 28, marginTop: 18 },
  ...
  report: { position: 'absolute', left: 27, right: 28, top: 517 - navigationHeader.contentLift, minHeight: 153, borderRadius: 22, borderWidth: 1, borderColor: 'rgba(221,224,225,.3)', padding: 21 },
  reportTitle: { color: colors.white, fontSize: 17, fontWeight: '700' },
  reportDate: { color: colors.white, fontSize: 13, marginTop: 5 },
  reportValue: { color: colors.white, fontSize: 28, fontWeight: '800', lineHeight: 36, marginTop: 5 },
